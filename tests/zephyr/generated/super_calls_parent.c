...
struct Base *Base_oz_alloc(void)
{
	...
	((struct OZObject *)obj)->_meta.class_id = OZ_CLASS_Base;
...
void Base_oz_free(struct Base *obj)
{
	...
	memset((char *)obj + sizeof(struct OZObject), 0xA5,
	       sizeof(struct Base) - sizeof(struct OZObject));
#endif
...
struct Child *Child_oz_alloc(void)
{
	...
	((struct OZObject *)obj)->_meta.class_id = OZ_CLASS_Child;
	oz_atomic_init(&((struct OZObject *)obj)->oz_refcount, 1);
	return obj;
}
...
void Child_oz_free(struct Child *obj)
{
	...
	oz_atomic_init(&((struct OZObject *)obj)->oz_refcount, OZ_REFCOUNT_FREED);
	memset((char *)obj + sizeof(struct OZObject), 0xA5,
	       sizeof(struct Child) - sizeof(struct OZObject));
#endif
