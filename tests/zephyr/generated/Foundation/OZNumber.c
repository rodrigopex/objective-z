...
struct OZNumber *OZNumber_oz_alloc(void)
{
	...
	((struct OZObject *)obj)->_meta.class_id = OZ_CLASS_OZNumber;
...
void OZNumber_oz_free(struct OZNumber *obj)
{
	...
	memset((char *)obj + sizeof(struct OZObject), 0xA5,
	       sizeof(struct OZNumber) - sizeof(struct OZObject));
#endif
...
/* @compatibility_alias NSNumber OZNumber -- not needed, oz2c resolves classes by their own name only */
