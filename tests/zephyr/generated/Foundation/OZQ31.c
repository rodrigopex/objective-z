...
/* synthesized: backing storage for every OZQ31 instance -- 9 slot(s), sized from this translation unit's allocation sites, each counted once per call site of the body it escapes from (override with --pool-sizes) */
