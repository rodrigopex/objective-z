...
/* @protocol Togglable -- compile-time only, see oz2c_dispatch.h/.c */
...
struct LightSwitch *LightSwitch_oz_alloc(void)
{
	...
	((struct OZObject *)obj)->_meta.class_id = OZ_CLASS_LightSwitch;
...
struct Fan *Fan_oz_alloc(void)
{
	...
	((struct OZObject *)obj)->_meta.class_id = OZ_CLASS_Fan;
	oz_atomic_init(&((struct OZObject *)obj)->oz_refcount, 1);
	return obj;
}
