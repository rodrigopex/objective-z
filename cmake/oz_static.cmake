...
function(objz_transpile_sources_static target)
    ...
    #
    # Reachable only in a CONFIG_DEBUG build, and y within it (#395, which
    # replaced #358's soft default): the image is unaffected either way, but
    # each directive carries an absolute path and they roughly double the
    # generated C, which a release build has no use for. This flag is what
    # supplies the option -- oz2c emits no directive without it, which is
    # also what keeps a hand-run transpile (and the committed
    # tests/zephyr/generated C) free of one machine's absolute paths.
