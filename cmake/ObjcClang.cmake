...
function(_objz_write_compile_db)
    ...
    # We remove the cross-compilation target so clangd uses the macOS host
    # (non-fragile ObjC ABI), then inject the arch defines that Zephyr/CMSIS
    # headers need.
    _objz_get_clang_target_triple(_clangd_triple)

    set(_clangd_arch_defines "")
    if(CONFIG_ARM)
        if(CONFIG_CPU_CORTEX_M0 OR CONFIG_CPU_CORTEX_M0PLUS OR CONFIG_CPU_CORTEX_M1)
            set(_clangd_arch_defines
                "    - -D__ARM_ARCH=6\n\
...
Diagnostics:\n\
  ...
  Suppress:\n\
    ...
    message(STATUS "Objective-Z: generated ${_mod}/.clangd (target=${_clangd_triple})")
