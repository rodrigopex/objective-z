...
#define OZ_IMPL_Logger_dealloc(self, ...)	Logger_dealloc((struct Logger *)(self), ##__VA_ARGS__)
#define OZ_IMPL_Timer_dealloc(self, ...)	Timer_dealloc((struct Timer *)(self), ##__VA_ARGS__)
#define OZ_IMPL_OZObject_init(self, ...)	OZObject_init((struct OZObject *)(self), ##__VA_ARGS__)
#define OZ_IMPL_Logger_init(self, ...)	OZObject_init((struct OZObject *)(self), ##__VA_ARGS__)
#define OZ_IMPL_Timer_init(self, ...)	OZObject_init((struct OZObject *)(self), ##__VA_ARGS__)
