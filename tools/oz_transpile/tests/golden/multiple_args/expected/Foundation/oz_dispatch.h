...
#define OZ_IMPL_Color_dealloc(self, ...)	Color_dealloc((struct Color *)(self), ##__VA_ARGS__)
#define OZ_IMPL_OZObject_init(self, ...)	OZObject_init((struct OZObject *)(self), ##__VA_ARGS__)
#define OZ_IMPL_Color_init(self, ...)	OZObject_init((struct OZObject *)(self), ##__VA_ARGS__)
