...
const OZ_fn_dealloc OZ_PROTOCOL_RESOLVE_dealloc[OZ_CLASS_COUNT] = {
	...
	[OZ_CLASS_Controller] = (OZ_fn_dealloc)Controller_dealloc,
	[OZ_CLASS_Sensor] = (OZ_fn_dealloc)Sensor_dealloc,
};

const OZ_fn_init OZ_PROTOCOL_RESOLVE_init[OZ_CLASS_COUNT] = {
	[OZ_CLASS_OZObject] = (OZ_fn_init)OZObject_init,
	[OZ_CLASS_Controller] = (OZ_fn_init)OZObject_init,
	[OZ_CLASS_Sensor] = (OZ_fn_init)OZObject_init,
};
