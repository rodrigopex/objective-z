...
#define OZ_IMPL_Controller_dealloc(self, ...)	Controller_dealloc((struct Controller *)(self), ##__VA_ARGS__)
#define OZ_IMPL_Sensor_dealloc(self, ...)	Sensor_dealloc((struct Sensor *)(self), ##__VA_ARGS__)
#define OZ_IMPL_OZObject_init(self, ...)	OZObject_init((struct OZObject *)(self), ##__VA_ARGS__)
#define OZ_IMPL_Controller_init(self, ...)	OZObject_init((struct OZObject *)(self), ##__VA_ARGS__)
#define OZ_IMPL_Sensor_init(self, ...)	OZObject_init((struct OZObject *)(self), ##__VA_ARGS__)
